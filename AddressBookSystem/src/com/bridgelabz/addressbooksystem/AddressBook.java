...
public class AddressBook implements AddressBookIF {
	...
	public void addPersonToCity(ContactPerson contact) {
		if (personByCity.containsKey(contact.getClass().getClass())) {
			personByCity.get(contact.getClass().getClass()).add(contact);
		}
		else {
			ArrayList<ContactPerson> cityList = new ArrayList<ContactPerson>();
			cityList.add(contact);
			personByCity.put(contact.getClass().getClass(), cityList);
		}
	}

	public void addPersonToState(ContactPerson contact) {
		if (personByState.containsKey(contact.getClass().getName())) {			
			personByState.get(contact.getClass().getName()).add(contact);
		}
		else {
			ArrayList<ContactPerson> stateList = new ArrayList<ContactPerson>();
			stateList.add(contact);
			personByState.put(contact.getClass().getName(), stateList);
		}
	}
	...
	public void sortAddressBook(int sortingChoice) {
		...
		switch(sortingChoice) {
			...
			case 2: sortedContactList = contactList.values().stream()
					.sorted((firstperson, secondperson) -> firstperson.getClass().getClass().compareTo(secondperson.getClass().getClass()))
					.collect(Collectors.toList());
					printSortedList(sortedContactList);
					break;
				
			case 3: sortedContactList = contactList.values().stream()
					.sorted((firstperson, secondperson) -> firstperson.getClass().getName().compareTo(secondperson.getClass().getName()))
					.collect(Collectors.toList());
					printSortedList(sortedContactList);
					break;
				
			case 4: sortedContactList = contactList.values().stream()
					.sorted((firstperson, secondperson) -> Long.valueOf(firstperson.getClass().getZip()).compareTo(Long.valueOf(secondperson.getClass().getZip())))
					.collect(Collectors.toList());
					printSortedList(sortedContactList);
					break;
		}
